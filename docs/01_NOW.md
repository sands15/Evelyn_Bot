...
- validation GET은 현재 consent를 반환하고 local mic capture·Opus/STT startup·Bridge·TTS warmup/control·router, Discord playback trace·Minecraft snapshot, memory mirror·self-identity queue와 Main/Fast failed-tool·vision metrics/watch는 예외 원문을 가린다. Runtime Health probe도 timeout을 지킨다.
...
- CI-equivalent 전체 3,228개(skip 22), Local Bridge continuity 74개, Mindcraft 56개,
