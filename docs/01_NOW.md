...
- Main↔Fast continuity는 선택 session 활동시각으로 ordering·stale·revocation/reset을 판정해 무관한 session commit의 재정렬·부활을 막고 선택 대상의 누락 metadata는 fail-closed한다. CI-equivalent 전체 3,277개(skip 22),
  continuity 인접 276개(skip 3), voice 659개(skip 5)와 구문 검사가 통과했다. 마이크·Discord·Minecraft·Docker는 기동하지 않았다.
