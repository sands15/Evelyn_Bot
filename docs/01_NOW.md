...
- 2026-08-08 response/outbound와 semantic/recomposition Sub-LLM을 shared reader로
  바꾸고 handoff의 current-state writer 재검증을 고정했다. fresh write-backed recall,
  Sub-LLM 중 삭제·편집 Busy retry와 journal rotation은 남은 P1이다.
...
- CI-equivalent 전체 3,100개(skip 21), 관련 집중 검증과 JS 구문이 통과했다. 현재
