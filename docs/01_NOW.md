...
- validation GET은 현재 consent를 반환하고 local mic capture·STT·Bridge·TTS warmup/control·router, memory mirror·self-identity queue와 Main/Fast failed-tool·vision metrics는 예외 원문을 가린다. Runtime Health probe도 timeout을 지킨다.
