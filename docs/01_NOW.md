...
- 2026-08-09 Mindcraft history는 bounded process-local·no-mount이며 Codex는 off다.
  ...
  recovery step은 exact history snapshot의 process-local one-shot issuance만 소비하고, 손상 world-effect policy는 validation 예외나 false-ready 대신 fixed blocker로 닫힌다. Disconnect/kick reason도 분류에만 쓰고 output에는 고정 문구만 남긴다.
...
- CI-equivalent 전체 3,235개(skip 22), Local Bridge continuity 74개, Mindcraft 56개,
