...
- validation GET은 현재 consent를 반환하고 STT·Bridge·TTS warmup/control·router, memory mirror·self-identity queue와 Main/Fast failed-tool·vision metrics는 예외 원문을 가린다. Runtime Health probe도 timeout을 지킨다.
...
- CI-equivalent 전체 3,223개(skip 22), Local Bridge continuity 74개, Mindcraft 56개,
