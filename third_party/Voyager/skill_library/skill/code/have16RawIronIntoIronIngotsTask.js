async function have16RawIronIntoIronIngotsTask(bot) {
  ...
  if (!furnaceBlock) {
    ...
    await placeItem(bot, "furnace", bot.entity.position.floored().offset(1, 0, 0));
  ...
  const fuelCandidates = ["coal", "oak_planks", "birch_planks", "spruce_planks", "jungle_planks", "acacia_planks", "dark_oak_planks", "mangrove_planks", "cherry_planks", "oak_log", "birch_log"];
