async function have16RawIronIntoIronIngotsTask(bot) {
  ...
  if (countItem(rawName) < neededIngots) {
  ...
  if (!furnaceBlock) {
    ...
    const candidates = [base.offset(1, 0, 0), base.offset(-1, 0, 0), base.offset(0, 0, 1), base.offset(0, 0, -1), base.offset(2, 0, 0), base.offset(0, 0, 2)];
    let placed = false;
