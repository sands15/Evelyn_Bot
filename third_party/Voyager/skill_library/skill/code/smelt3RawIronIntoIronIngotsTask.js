async function smelt3RawIronIntoIronIngotsTask(bot) {
  ...
  const neededRaw = target - currentIngot; // amount to smelt this round
  ...
  // Ensure furnace exists; if not, place it (only if we have a furnace item)
  ...
  // Smelt using the provided primitive
