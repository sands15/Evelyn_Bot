...
"%WT_EXE%" -w %WT_WINDOW% new-tab --title "TTS" powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%SUPERVISOR%" -Name "TTS" -Workdir "%~dp0.." -Command "& '%~dp0start_tts.ps1' -Supervised"
