...
if "%SUB_LLM_MODEL%"=="" set "SUB_LLM_MODEL=/mnt/c/Users/Admin/llama.cpp/models/EXAONE-3.5-2.4B-Instruct-Q6_K.gguf"
...
if "%SUMMARY_MODEL_NAME%"=="" set "SUMMARY_MODEL_NAME=EXAONE-3.5-2.4B-Instruct-Q6_K.gguf"
