...
if "%SUB_LLM_HF%"=="" set "SUB_LLM_HF=LGAI-EXAONE/EXAONE-3.5-2.4B-Instruct-GGUF:EXAONE-3.5-2.4B-Instruct-Q4_K_M.gguf"
...
if "%ROUTER_LLM_HF%"=="" set "ROUTER_LLM_HF=LGAI-EXAONE/EXAONE-3.5-2.4B-Instruct-GGUF:EXAONE-3.5-2.4B-Instruct-Q4_K_M.gguf"
