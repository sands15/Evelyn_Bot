...
if "%OMNIVOICE_NUM_STEP%"=="" set "OMNIVOICE_NUM_STEP=12"
if "%OMNIVOICE_STREAM_STRATEGY%"=="" set "OMNIVOICE_STREAM_STRATEGY=sentence"
if "%OMNIVOICE_STREAM_FOLLOWUP_STRATEGY%"=="" set "OMNIVOICE_STREAM_FOLLOWUP_STRATEGY=sentence"
...
if "%VOYAGER_ACTION_BACKEND%"=="" set "VOYAGER_ACTION_BACKEND=local"
