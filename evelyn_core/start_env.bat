...
if "%SUB_LLM_HF%"=="" set "SUB_LLM_HF=Qwen/Qwen2.5-1.5B-Instruct-GGUF:qwen2.5-1.5b-instruct-q4_k_m.gguf"
...
if "%SUMMARY_MODEL_NAME%"=="" set "SUMMARY_MODEL_NAME=qwen2.5-1.5b-instruct-q4_k_m.gguf"
...
if "%ROUTER_LLM_HF%"=="" set "ROUTER_LLM_HF=Qwen/Qwen2.5-1.5B-Instruct-GGUF:qwen2.5-1.5b-instruct-q4_k_m.gguf"
if "%ROUTER_MODEL_NAME%"=="" set "ROUTER_MODEL_NAME=qwen2.5-1.5b-instruct-q4_k_m.gguf"
