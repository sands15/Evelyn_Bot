...
if "%MAIN_LLM_MODEL%"=="" set "MAIN_LLM_MODEL=/mnt/c/Users/Admin/llama.cpp/models/kanana-1.5-8b-instruct-2505-q4_k_m.gguf"
if "%MAIN_LLM_LORA%"=="" set "MAIN_LLM_LORA=/mnt/c/Evelyn/training/evelyn_lora_kanana_v1/outputs/kanana_evelyn_core_clean_v46_lora.gguf"
...
if "%LLM_MODEL_NAME%"=="" set "LLM_MODEL_NAME=kanana-1.5-8b-instruct-2505-q4_k_m+evelyn-core-clean-v46-lora"
