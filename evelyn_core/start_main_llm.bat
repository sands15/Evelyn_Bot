...
set "WSL_CMD=MAIN_LLM_BACKEND='%MAIN_LLM_BACKEND%' MAIN_LLM_VENV_ACT='%MAIN_LLM_VENV_ACT%' MAIN_LLM_GPU='%MAIN_LLM_GPU%' MAIN_LLM_PORT='%MAIN_LLM_PORT%' MAIN_LLM_CONTEXT='%MAIN_LLM_CONTEXT%' MAIN_LLM_N_PARALLEL='%MAIN_LLM_N_PARALLEL%' MAIN_LLM_CACHE_REUSE='%MAIN_LLM_CACHE_REUSE%' MAIN_LLM_HF='%MAIN_LLM_HF%' MAIN_LLM_MODEL='%MAIN_LLM_MODEL%' MAIN_LLM_QUANTIZATION='%MAIN_LLM_QUANTIZATION%' MAIN_LLM_DTYPE='%MAIN_LLM_DTYPE%' MAIN_LLM_GPU_MEMORY_UTILIZATION='%MAIN_LLM_GPU_MEMORY_UTILIZATION%' MAIN_LLM_CHAT_TEMPLATE_CONTENT_FORMAT='%MAIN_LLM_CHAT_TEMPLATE_CONTENT_FORMAT%' MAIN_LLM_ENFORCE_EAGER='%MAIN_LLM_ENFORCE_EAGER%' MAIN_LLM_FLASHINFER_SAMPLER='%MAIN_LLM_FLASHINFER_SAMPLER%' bash /mnt/c/Evelyn/evelyn_core/runtime/launchers/run_main_llm.sh"
