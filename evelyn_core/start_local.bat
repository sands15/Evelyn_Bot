...
set "LOCAL_ONLY=true"
if "%DISCORD_BOT_TOKEN%"=="" set "DISCORD_BOT_TOKEN=local-only-disabled"
if "%EVELYN_CODEX_AUTH_FILE%"=="" set "EVELYN_CODEX_AUTH_FILE=%~dp0..\runtime_artifacts\secrets\codex_device_home\auth.json"
if "%EVELYN_CODEX_CONFIG_FILE%"=="" set "EVELYN_CODEX_CONFIG_FILE=%~dp0..\runtime_artifacts\secrets\codex_device_home\config.toml"
...
if "%LOCAL_MIC_ENABLED%"=="" set "LOCAL_MIC_ENABLED=false"
...
if "%LOCAL_MIC_MIN_VOICED_MS%"=="" set "LOCAL_MIC_MIN_VOICED_MS=280"
if "%LOCAL_MIC_WAVEFORM_FILTER_ENABLED%"=="" set "LOCAL_MIC_WAVEFORM_FILTER_ENABLED=true"
