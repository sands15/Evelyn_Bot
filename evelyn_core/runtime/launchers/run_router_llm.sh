...
ROUTER_LLM_GPU="${ROUTER_LLM_GPU:-GPU-96c554e6-feef-2980-6722-efcb0af098f9}"
...
ROUTER_LLM_MODEL="${ROUTER_LLM_MODEL:-/mnt/c/Users/Admin/llama.cpp/models/gemma-4-E2B-it-text-only-GGUF/gemma-4-E2B-it-Q4_K_M.gguf}"
